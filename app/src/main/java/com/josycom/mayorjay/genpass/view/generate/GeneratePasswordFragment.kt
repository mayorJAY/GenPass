package com.josycom.mayorjay.genpass.view.generate
...
import com.josycom.mayorjay.genpass.viewmodel.GeneratePasswordViewModelFactory
...
class GeneratePasswordFragment : Fragment() {
    ...
    private val viewModel: GeneratePasswordViewModel by viewModels {
        ...
        GeneratePasswordViewModelFactory(repository)
    }
